...
const Header = () => {
  ...
  return (
    <div className='flex flex-col w-full  items-center justify-center m-auto p-4  mt-15'>
        ...
        <button onClick={() => navigate('/login')} className='mt-5 bg-gradient-to-l shadow-md from-blue-400 to-green-400 text-black py-2 px-4 rounded-full hover:scale-105 transition-all duration-600 ease-in-out'>Start Building Habits</button>
